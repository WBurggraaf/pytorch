...
class KernelProfileNumelScopeTest(TestCase):
    ...
    def _wrapper(self):
        ...
        wrapper.kernel_profile_scope_hoist_index = None
        wrapper.lines = []
        # The scope brackets snapshot the declaration memos they shadow.
        wrapper.computed_sizes = OrderedSet()
        wrapper.computed_sizes_stack = []
        wrapper.codegen_int_array_var_cache = {}
        wrapper._kernel_profile_scope_state = []
        return wrapper
